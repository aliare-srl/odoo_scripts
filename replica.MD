...
```sql
postgres=# CREATE USER replica_user WITH REPLICATION PASSWORD ‘st0ngpa$$word’;
postgres=# CREATE USER replica_rewind WITH PASSWORD ‘st0ngpa$$word2’;
...
```bash # cambiar al usuario que ejecuta odoo
